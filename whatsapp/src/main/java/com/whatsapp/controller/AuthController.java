...
import com.whatsapp.payload.LoginRequest;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> loginHandler(@RequestBody LoginRequest request) {
        ...
        Authentication authenticated = this.authenticate(email, password);
        SecurityContextHolder.getContext().setAuthentication(authenticated);

        String jwt = this.tokenProvider.generateToken(authenticated);
